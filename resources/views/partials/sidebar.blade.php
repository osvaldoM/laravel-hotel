...
<div class="bg-light border-right sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="/rooms" class="list-group-item list-group-item-action bg-light">Rooms</a>
        <a href="/bookings" class="list-group-item list-group-item-action bg-light">Bookings</a>
    </div>
</div>
<!-- /#sidebar-wrapper -->
