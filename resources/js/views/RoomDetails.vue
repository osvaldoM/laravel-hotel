        ...
        <div v-if="room" class="room-details">
            ...
            <form method="PUT" v-bind:action="'/api/v1/rooms/' + room.id" v-on:submit="updateRoom">
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control" id="hotel-name" placeholder="Hotel name" v-model="room.name">
                </div>
                <div class="form-group">
                    <label for="room-type"></label>
                    <select name="room_type_id" type="text" class="form-control" id="room-type" placeholder="Hotel Phone number" v-model="room.room_type_id">
