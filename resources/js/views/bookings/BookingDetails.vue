        ...
        <div v-if="booking" class="booking-details">
            ...
            <form method="PUT" v-bind:action="'/api/v1/bookings/' + booking.id" v-on:submit="updateBooking">
                ...
                <div class="form-group">
                    ...
                    <datepicker :value="(booking.end_date)" id="end-date" name="start_date"  format="yyyy/MM/dd" bootstrap-styling=true required calendar-button calendar-button-icon="oi oi-calendar"></datepicker>
                </div>
